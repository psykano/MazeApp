...
- [x] Setup Theme & CSS Architecture
...
- [x] Implement Pre-game Configuration UI
...
- [x] Set up `<canvas>` rendering logic
...
- [x] Implement User Drawing Mechanics
...
- [x] Implement Gameplay Validation logic
